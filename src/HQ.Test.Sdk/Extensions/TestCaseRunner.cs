...
namespace HQ.Test.Sdk.Xunit.Extensions
{
    public class TestCaseRunner : XunitTestCaseRunner
    {
        ...
        {
            return new TestRunner(new XunitTest(TestCase, DisplayName), MessageBus, TestClass, ConstructorArguments,
                TestMethod, TestMethodArguments, SkipReason, BeforeAfterAttributes, new ExceptionAggregator(Aggregator),
