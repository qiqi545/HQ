...
namespace HQ.Data.Contracts
{
    ...
    public interface IObjectGetRepository<TObject> where TObject : IObject
    {
        ...
        Task<Operation<IStream<TObject>>> GetAsync(IEnumerable<long> ids = null, long startingAt = 0, int? count = null, FieldOptions fields = null, FilterOptions filter = null, ProjectionOptions projection = null);
    }
}
