...
{
	public interface IObjectSaveService<TKey> where TKey : IEquatable<TKey>
	{
	...
	public interface IObjectSaveService<in TObject, TKey> where TObject : IObject<TKey> where TKey : IEquatable<TKey>
	{
