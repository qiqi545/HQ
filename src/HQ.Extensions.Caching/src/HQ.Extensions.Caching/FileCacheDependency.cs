...
namespace HQ.Extensions.Caching
{
    public class FileCacheDependency : ICacheDependency
    {
        ...
        /// <param name="filters">Filter strings used to determine what files or folders to monitor. Example: **/*.cs, *.*, subFolder/**/*.cshtml.</param>
        public FileCacheDependency(string rootDirectory, ExclusionFilters exclusionFilters = ExclusionFilters.Sensitive, params string[] filters)
        {
