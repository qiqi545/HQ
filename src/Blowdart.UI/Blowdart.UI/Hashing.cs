...
namespace Blowdart.UI
{
    ...
    {
        public static Value128 MurmurHash3(byte[] key, Value128 seed = default(Value128))
        {
            var len = key.Length;
            var nblocks = len / 16;
        ...
        public static Value128 MurmurHash3(string key, Value128 seed = default(Value128))
        {
        ...
        public static Value128 MurmurHash3(StringBuilder key, Value128 seed = default(Value128))
        {
            var len = key.Length * 2; // chars are 16 bits
            var nblocks = key.Length / 8;
        ...
        public static Value128 MurmurHash3(ulong key, Value128 seed = default(Value128))
        {
            const int len = 4;
