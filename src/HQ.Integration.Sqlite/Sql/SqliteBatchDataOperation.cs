...
namespace HQ.Integration.Sqlite.Sql
{
	...
	{
		public Task<(SqliteOptions, object)> BeforeAsync(IDbConnection connection, IDataDescriptor descriptor,
		...
		public Task AfterAsync(IDbConnection connection, IDataDescriptor descriptor, SqliteOptions options,
			object userState,
