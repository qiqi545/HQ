...
namespace HQ.Data.Streaming.Fields
{
    ...
    public readonly ref struct Int16Field
    {
        ...
        public short? Value => Initialized ? !_encoding.TryParse(_buffer, out short value) ? default(short?) : value : default;
        ...
        public string DisplayName => $"{nameof(Int16Field).Replace("Field", string.Empty)}: {Value} ({RawValue ?? "<NULL>"}:{_encoding.BodyName})";
