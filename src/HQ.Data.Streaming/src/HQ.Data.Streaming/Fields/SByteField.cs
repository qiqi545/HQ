...
namespace HQ.Data.Streaming.Fields
{
    ...
    public readonly ref struct SByteField
    {
        ...
        public sbyte? Value => Initialized ? !_encoding.TryParse(_buffer, out sbyte value) ? default(sbyte?) : value : default;
        ...
        public string DisplayName => $"{nameof(SByteField).Replace("Field", string.Empty)}: {Value} ({RawValue ?? "<NULL>"}:{_encoding.BodyName})";
