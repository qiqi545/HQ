...
namespace HQ.Cadence
{
	...
	{
		readonly ConcurrentDictionary<MetricName, IMetric> _metrics;
		...
		public IMetric AddOrUpdate<T>(MetricName name, T metric, Func<MetricName, IMetric, IMetric> func) where T : IMetric
		{
