...
{
	/// <summary>
	///     Money is immutable and coupled to the <see cref="P:HQ.Common.Money.CurrencyInfo" /> it belongs
	///     to at all times. In most cases, the code will attempt to determine
	///     the correct <see cref="P:HQ.Common.Money.CurrencyInfo" /> on its own based on the culture of
