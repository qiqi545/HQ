...
namespace Paging
{
    public class PagedQueryable
    {
        ...
        static PagedQueryable()
        {
            DefaultPageSize = 10;
        }

        protected PagedQueryable()
        {
    ...
    public class PagedQueryable<T> : PagedQueryable, IPagedQueryable<T>
    {
        ...
        public PagedQueryable(IQueryable<T> source, int? page, int? count)
        {
            ...
            PageSize = !count.HasValue ? DefaultPageSize : count.Value;
