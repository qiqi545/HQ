...
namespace HQ.Extensions.Messaging.Bus
{
	public sealed class MessagePublisher : IMessagePublisher
	{
		...
		public MessagePublisher(IMessageAggregator aggregator) => _aggregator = aggregator;
		...
		private Func<object, bool> BuildByTypeDispatcher(Type superType)
		{
			...
			var dispatchers = new Dictionary<Type, MethodInfo> {{superType, publishTyped.MakeGenericMethod(superType)}};
