...
namespace HQ.UI.Web
{
	public static class Installer
    {
        ...
        public static IServiceCollection AddUi(this IServiceCollection services, params Assembly[] uiAssemblies)
        {
	        return AddUi(services, null, uiAssemblies);
        }

        public static IServiceCollection AddUi(this IServiceCollection services, IHostingEnvironment env, params Assembly[] uiAssemblies)
        {
			if(env != null)
        ...
        public static void UseUi(this IApplicationBuilder app, Action<LayoutRoot> layout = null)
        {
			app.UseUi(layout, false);
        }

		internal static void UseUi(this IApplicationBuilder app, Action<LayoutRoot> layout, bool standalone)
        {
