...
{ 
    ...
    { 
		...
		public HandlerFactory(IAssemblyBuilder builder, params Assembly[] defaultDependencies) : this(builder,
			defaultDependencies.AsEnumerable())
		{
		}

		public HandlerFactory(params Assembly[] defaultDependencies) : this(AssemblyBuilder.Default.Value,
			defaultDependencies.AsEnumerable())
		{
		}
