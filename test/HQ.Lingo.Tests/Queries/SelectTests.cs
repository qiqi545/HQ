...
namespace HQ.Lingo.Tests.Queries
{
    public class SelectTests
    {
        ...
        public void Select_all_static_no_where_no_order_by()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User", query.Sql);
            Assert.Equal(0, query.Parameters.Count);
            _console.WriteLine(query.Sql);
        }
        ...
        public void Select_all_static_no_where_with_order_by_ascending()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User ORDER BY Email ASC", query.Sql);
            Assert.Equal(0, query.Parameters.Count);
            _console.WriteLine(query.Sql);
        }
        ...
        public void Select_all_static_no_where_with_order_by_descending()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User ORDER BY Email DESC", query.Sql);
            Assert.Equal(0, query.Parameters.Count);
            _console.WriteLine(query.Sql);
        }
        ...
        public void Select_all_static_with_where_and_multiple_order_by()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User WHERE Id = @Id ORDER BY Id ASC, Email DESC", query.Sql);
        ...
        public void Select_all_static_with_where_and_multiple_order_by_and_paging()
        {
            ...
            Assert.Equal(
                "SELECT Id, CreatedAt, Email FROM User WHERE Id = @Id ORDER BY Id ASC, Email DESC LIMIT @PerPage OFFSET @Page",
                query.Sql);
        ...
        public void Select_all_static_with_where_no_order_by()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User WHERE Id = @Id", query.Sql);
            Assert.Equal(1, query.Parameters.Count);
            Assert.Equal(2, query.Parameters["@Id"]);
            _console.WriteLine(query.Sql);
        }
        ...
        public void Select_all_static_with_where_with_order_by_descending()
        {
            ...
            Assert.Equal("SELECT Id, CreatedAt, Email FROM User WHERE Id = @Id ORDER BY Email DESC", query.Sql);
            Assert.Equal(1, query.Parameters.Count);
            Assert.Equal(2, query.Parameters["@Id"]);
            _console.WriteLine(query.Sql);
        }
        ...
        public void Select_subset_by_compound_contract_example()
        {
            ...
            Assert.Equal("SELECT Email, Id FROM User WHERE Id = @Id ORDER BY Id ASC LIMIT @PerPage OFFSET @Page",
                query.Sql);
            Assert.Equal(3, query.Parameters.Count);
        ...
        public void Select_subset_by_concrete_example()
        {
            ...
            Assert.Equal(
                "SELECT Id, CreatedAt, Email FROM User WHERE Id = @Id ORDER BY Id ASC LIMIT @PerPage OFFSET @Page",
                query.Sql);
            Assert.Equal(3, query.Parameters.Count);
            Assert.Equal(1, query.Parameters["@Id"]);
            Assert.Equal(1, query.Parameters["@Page"]);
