...
* Helpful - Use compiled Razor helpers to make building UI a breeze
...
[Add image link when it's on GitHub]

You'll notice that IPageable has properties PageStart, PageEnd, and PageCount to 
help determine the index of the items your data slice and the actual number of items it 
